...
public class TerrainMesh : MonoBehaviour
{
    ...
    public void Triangulate(Cell[] cells)
    {
      ...
      for (int i = 0; i < cells.Length; i++)
      {
        ...
        //CreateTriangle(cells[i]);

        AddQuad(cells[i].Position, cells[i].GetNeighbor(Direction.N).Position,
        cells[i].GetNeighbor(Direction.E).Position, cells[i].GetNeighbor(Direction.E).GetNeighbor(Direction.N).Position);
      }
    ...
    void CreateTriangle(Cell cell)
    {
      Vector3 v1 = cell.Position, v2, v3;
