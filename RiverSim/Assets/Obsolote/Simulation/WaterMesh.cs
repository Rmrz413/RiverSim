...
public class WaterMesh : MonoBehaviour
{
    ...
    {
        Vector3 v1 = new Vector3(cell.Position.x - (Metrics_Old.CellSize / 2.0f), cell.Elevation, cell.Position.z + (Metrics_Old.CellSize / 2.0f));
        Vector3 v2 = new Vector3(cell.Position.x + (Metrics_Old.CellSize / 2.0f), cell.Elevation, cell.Position.z + (Metrics_Old.CellSize / 2.0f));
        Vector3 v3 = new Vector3(cell.Position.x - (Metrics_Old.CellSize / 2.0f), cell.Elevation, cell.Position.z - (Metrics_Old.CellSize / 2.0f));
        Vector3 v4 = new Vector3(cell.Position.x + (Metrics_Old.CellSize / 2.0f), cell.Elevation, cell.Position.z - (Metrics_Old.CellSize / 2.0f));
        AddQuad(v1,v2,v3,v4);
    }
  ...
  void CalculateConnectionN(Cell cell)
  {
    ...
    Vector3 v1 = new Vector3(cell.Position.x - (Metrics_Old.CellSize / 2.0f), cell.Elevation, cell.Position.z + (Metrics_Old.CellSize / 2.0f));
    Vector3 v2 = new Vector3(neighbour.Position.x - (Metrics_Old.CellSize / 2.0f), neighbour.Elevation, neighbour.Position.z - (Metrics_Old.CellSize / 2.0f));
    Vector3 v3 = new Vector3(cell.Position.x + (Metrics_Old.CellSize / 2.0f), cell.Elevation, cell.Position.z + (Metrics_Old.CellSize / 2.0f));
    Vector3 v4 = new Vector3(neighbour.Position.x + (Metrics_Old.CellSize / 2.0f), neighbour.Elevation, neighbour.Position.z - (Metrics_Old.CellSize / 2.0f));
